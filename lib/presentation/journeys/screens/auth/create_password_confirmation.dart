...
class CreatedPasswordConfirmation extends StatelessWidget {

  const CreatedPasswordConfirmation({Key? key}) : super(key: key);
                ...
                child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: Column(
                            children: [
                              ...
                              const Text(
                                  TextLiterals.createPasswordConfirmation,
                      ...
                      AuthenticationButton(
                        isEnabled: true,
                        onClicked: ()=> Navigator.pushNamedAndRemoveUntil(context, RouteLiterals.loginRoute, (route) => false),

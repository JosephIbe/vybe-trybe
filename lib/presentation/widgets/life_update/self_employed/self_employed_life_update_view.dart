...
class SelfEmployedLifeUpdateView extends StatefulWidget {

  const SelfEmployedLifeUpdateView({Key? key}) : super(key: key);

  @override
  _SelfEmployedLifeUpdateViewState createState() => _SelfEmployedLifeUpdateViewState();
}

late Size size;

class _SelfEmployedLifeUpdateViewState extends State<SelfEmployedLifeUpdateView> {
